                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6">
                                <div className="single-footer mb-sm-40">
                                    <h3 className="footer-title">secondaryrmation</h3>
                                    <div className="footer-content">
                                        <ul className="footer-list">
                                            ...
                                            <li>
                                                <a href="#">Delivery secondaryrmation</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="login.html">FAQs</a>
                                            </li>
                                            <li>
                                                <a href="login.html">Return Policy</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="single-footer mb-sm-40">
                                    ...
                                    <div className="footer-content">
                                        <ul className="footer-list address-content">
                                            <li>
                                                <i className="lnr lnr-map-marker" /> Address: 169-C, Technohub, Dubai Silicon Oasis.
                </li>
                                            <li>
                                                <i className="lnr lnr-envelope" />
                                                <a href="#"> mail Us: Support@truemart.com
                  </a>
                                            </li>
                                            <li>
                                                <i className="lnr lnr-phone-handset" /> Phone: (+800) 123 456 789)
                </li>
                                        </ul>
                                        <div className="payment mt-25 bdr-top pt-30">
                                            <a href="#">
                                                <img className="img" src="img/payment/1.png" alt="payment-image" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="container">
                        <div className="footer-middle-content pt-20 pb-30">
                            <ul className="social-footer">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="img/icon/social-img1.png" alt="google play" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="img/icon/social-img2.png" alt="app store" />
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="footer-bottom pb-30">
                    <div className="container">
                        <div className="copyright-text text-center">
                            <p>Copyright © 2018
          <a target="_blank" href="#">Truemart</a> All Rights Reserved.</p>
                        </div>
                    </div>
                    {/* Container End */}
                </div>
