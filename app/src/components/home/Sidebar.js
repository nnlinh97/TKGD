                ...
                <div className="vertical-menu mb-all-30">
                    <nav>
                        <ul className="vertical-menu-list">
                            <li className=""><a href="shop.html"><span><img src="img/vertical-menu/1.png" alt="menu-icon" /></span>Sữa<i
                                className="fa fa-angle-right" aria-hidden="true"></i></a>

                                <ul className="ht-dropdown mega-child">
                                    <li><a href="shop.html">Nhãn hiệu <i className="fa fa-angle-right"></i></a>
                                        <ul className="ht-dropdown mega-child">
                                    ...
                                    <li><a href="shop.html">Độ tuổi <i className="fa fa-angle-right"></i></a>
                                        <ul className="ht-dropdown mega-child">
                            ...
                            <li><a href="shop.html"><span><img src="img/vertical-menu/3.png" alt="menu-icon" /></span>Đồ
                                            dùng vệ sinh<i className="fa fa-angle-right" aria-hidden="true"></i></a>
                            ...
                            <li><a href="shop.html"><span><img src="img/vertical-menu/6.png" alt="menu-icon" /></span>Quần
                                            áo & Thời trang<i className="fa fa-angle-right" aria-hidden="true"></i></a>
                            ...
                            <li><a href="shop.html"><span><img src="img/vertical-menu/7.png" alt="menu-icon" /></span>Đồ
                                            chơi<i className="fa fa-angle-right" aria-hidden="true"></i></a>
                            ...
                            <li><a href="shop.html"><span><img src="img/vertical-menu/4.png" alt="menu-icon" /></span>Mẹ
                                            bầu và sau sinh<i className="fa fa-angle-right" aria-hidden="true"></i>
                            </a>
                                <ul className="ht-dropdown megamenu megamenu-three">
                                    <li className="single-megamenu">
                                        <ul>
